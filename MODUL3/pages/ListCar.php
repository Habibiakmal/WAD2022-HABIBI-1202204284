  ...
  <nav class="navbar navbar-expand-lg bg-primary">
    <div class="container">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
        ...
        <a href="Add.php" style="background-color: white; color:blue; border-radius: 5px; text-decoration: none; width: 110px; height: 35px; display:flex; justify-content:center; align-items:center; font-weight:500;">Add Car</a>
      </div>
    </div>
  </nav>
  <section id="list" style="padding-top: 50px; padding-bottom: 50px;">
    <div class="container">
      <div>
        ...
        <p style="font-family: 'Raleway'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 19px; color: #757575; margin-top: 20px;">List Show Room Muhammad Habibi Akmal_1202204284</p>
            ...
            while ($data = mysqli_fetch_assoc($result)) {
              echo "<div class='card cardcontent' style='background: #ffffff; box-shadow: 6px 14px 40px rgba(210, 210, 210, 0.6); border-radius: 16px; width: 400px; margin-top: 50px;'>
                      ...
                      <div class='card-body'>
                        ...
                        <span class='d-flex'>
                          <a href='Detail-Ema.php?id=" . $data["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
